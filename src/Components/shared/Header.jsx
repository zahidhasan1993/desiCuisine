...
const Header = () => {
  return (
    <div className='md:grid md:grid-cols-3 md:gap-8 justify-center items-center'>
      <div className='mt-9'>
        <h1 className='text-3xl'><span className='text-5xl font-bold text-red-700'>Welcome</span> to the food world of <span className='text-5xl font-bold text-red-700'>Bangladesh</span></h1>
